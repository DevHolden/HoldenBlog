...
public class UserController {
	...
	public String kakaoCallback(String code) { // Data를 리턴해주는 컨트롤러 함수
		...
		String client_id = "98e1a5ca5513e2879c3643cc29dbf174";
		...
		// UUID란? 중복되지 않는 어떠한 특정 값을 만들어내는 알고리즘.
		...
		if (originUser.getUsername() == null) {
			System.out.println("기존 회원이 아니기에 회원 가입을 진행합니다.");
			userService.회원가입(kakaoUser);
			System.out.println("카카오 회원가입 종료");
		}

		System.out.println("로그인을 진행합니다.");
		// 로그인 처리
		Authentication authentication = authenticationManger.authenticate(
				new UsernamePasswordAuthenticationToken(kakaoUser.getUsername(), blogKey));
